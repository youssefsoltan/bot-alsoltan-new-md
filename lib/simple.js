	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363225955338874@newsletter',
            newsletterName: '𝐵𝛩𝑇 𝐴𝐿 𝑺𝛩𝐿𝑇𝐴𝑁  🇪🇬 (Update)', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363225955338874@newsletter", "120363225955338874@newsletter", "120363225955338874@newsletter", "𝐵𝛩𝑇 𝐴𝐿 𝑺𝛩𝐿𝑇𝐴𝑁  🇪🇬 (Update)"]
let canalNombre = ["𝐵𝛩𝑇 𝐴𝐿 𝑺𝛩𝐿𝑇𝐴𝑁  🇪🇬 (Update)", "𝐵𝛩𝑇 𝐴𝐿 𝑺𝛩𝐿𝑇𝐴𝑁  🇪🇬 (Update)", "𝐵𝛩𝑇 𝐴𝐿 𝑺𝛩𝐿𝑇𝐴𝑁  🇪🇬 (Update)", "𝐵𝛩𝑇 𝐴𝐿 𝑺𝛩𝐿𝑇𝐴𝑁  🇪🇬 (Update)"]
