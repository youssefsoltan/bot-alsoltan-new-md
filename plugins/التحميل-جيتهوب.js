...
const handler = async (m, { args, usedPrefix, command }) => {
  ...
  if (!args[0]) throw `يرجى تقديم رابط GitHub صحيح باستخدام الصيغة التالية: _${usedPrefix + command} https://github.com/BrunoSobrino/TheMystic-Bot-MD_`;
...
handler.command = /gitclone|repo|جيتهوب/i;
