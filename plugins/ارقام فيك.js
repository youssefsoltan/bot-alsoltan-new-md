...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    ...
    let pp = 'https://telegra.ph/file/ec15edb7e6568daafc093.png'';

    const cap = `${menu}\n╮────────────────────────╭ــ\n│ *أنا خدمة Bot al Soltan Fake Number Ai*\n│ بوت قادر على صنع الأرقام الوهمية.\n│[دولة] لعرض قائمة الدول.\n│[أرقام] لعرض قائمة الأرقام للدولة.\n│[رسائل] لعرض قائمة الرسائل للرقم \n│[كود] لنسخ كود الرسالة المحددة\n╯────────────────────────╰ـ`;
...
return await conn.relayMessage(m.chat, msg.message, { messageId: msg.key.id });
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, 'بوت السلطان', pp, [['حاول مجددا',`${usedPrefix + command} أرقام ${additionalLink}`]], null, null, m);
        }
      ...
      interactiveMessage: {
        ...
        nativeFlowMessage: {
          ...
          messageParamsJson: "",
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, 'بوت السلطان', pp, [['حاول مجددا',`${usedPrefix + command} رسائل ${additionalLink}`]], null, null, m);
        }
...
conn.sendButton(m.chat, caption, 'بوت السلطان', pp, [['الرئيسية',`${usedPrefix + command}`]], null, null, m);
    }
};
