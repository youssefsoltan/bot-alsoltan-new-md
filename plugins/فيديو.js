...
const handler = async (m, {command, usedPrefix, conn, text}) => {
  ...
  try {
    if (command == 'حملي') {
      conn.reply(m.chat, `*_⌛جاري التحميل⏳_*\n> *https://whatsapp.com/channel/0029VaL2bnW0rGiPZq8B5S2M*`, m);
      try {
