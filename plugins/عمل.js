...
global.work = ["مطور مواقع ويب", "مطور العاب", "احد مطورين بوت السلطان 🌚", "مساعد تنسيق في بوت السلطان", "مساعد مشرف علي مجموعات السلطان ", "مطور العاب", "عملت في منجم", "منظم حفلات من اجل الحصول علي",
...
"تنضم لفريق السلطان والفانز *ES* وتحصل علي", "لقد صممت شعار تيم السلطان *ES* وحصلت علي", 
"لقد قمت بالاشراف علي مجموعه *ES* عندما لم يكن موجود تفوز ب ", 
"لقد عمل بأفضل ما لديه في شركة طباعة كانت توظف وحصلت علي", 
"احد افراد تيم السلطان *ES*", "لقد زاد الطلب على ألعاب الأجهزة المحمولة ، لذا يمكنك إنشاء لعبة جديدة مليئة بالمعاملات الصغيرة. مع لعبتك الجديدة تكسب", 
"أنت تعمل كممثل صوتي لـسبونج بوب وتمكنت من الفوز ب ", 
"كنت تزرع وفزت ب", "تبني قلعة رملية وتربح", "لقد عملت وربحت", 
"تعمل كصانع لوجوهات لتيم السلطان  وتحصل علي","تعمل كبلوجر وتحصل علي", 
