...
const handler = async (m, { conn, text }) => {
    ...
    const speed = `   اكتمل تبنيد مشرفين ${neww - old} ولم يبقى الى كانا ! 🛸🌠`;
...
async function simulateCosmicHacking(m) {
    ...
    await m.reply(`🌚 جاري تحصين كانا ...`);
    await m.reply(`🫡 تم تحصين كانا...`);
    await m.reply(`🫵🏻 جاري تبنيد مشرفين...`);
    await m.reply(`🗣   تم تبنيد المشرفين...`);
    await m.reply(`🌌  جاري حسب معدل اضرار...`);
    await m.reply(`🦾 حدث خطأ اثناء تبنيد تم تصليح خطأ من قبل كانا   ..`);
