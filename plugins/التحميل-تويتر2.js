...
import fs from 'fs'; // تأكد من استيراد fs إذا لم يكن موجودًا

let enviando = false;
const handler = async (m, { conn, text, usedPrefix, command }) => {
  

  if (!text) throw `يرجى إدخال رابط تويتر. مثال: ${usedPrefix + command} https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw`;
  if (enviando) return;
  enviando = true;
